...
* **2025.01.30 🔥 Inference Update**: We now support dual-track ICL mode! You can prompt the model with a reference song, and it will generate a new song in a similar style (voice cloning, music style transfer, etc.). Try it out! See [demo video by Abram Jackson on X](https://x.com/abrakjamson/status/1885932885406093538). 🔥🔥🔥
