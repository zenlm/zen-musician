...
## License Agreement
Our model is licensed under Creative Commons Attribution Non Commercial 4.0, meaning the model weights themselves cannot be used for commercial purposes.

However, we ENCOURAGE artists and content creators to sample and incorporate outputs generated by our model into their own works, and even monetize them. The only requirement is to credit our name: YuE by M-A-P\&HKUST.
