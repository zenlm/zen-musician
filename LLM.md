# zen-musician — AI Knowledge Base

**Project**: zen-musician
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-musician
**HuggingFace**: https://huggingface.co/zenlm/zen-musician
**Last Updated**: 2026-02-27

## Overview

zen-musician is part of the Zen AI model family by Hanzo AI / Zen LM.
