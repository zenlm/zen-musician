...
\title{Zen Musician: Music Generation}
...
\begin{itemize}
    \item 7B parameter music model
    \item Lyrics-to-song generation
    \item Vocals + accompaniment
